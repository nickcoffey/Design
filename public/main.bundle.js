...
var JobComponent = (function () {
    function JobComponent(router, route, jobService, materialService, bidService, authService, laborService, alert, equipmentService, customerService) {
        this.router = router;
        this.route = route;
        this.jobService = jobService;
        this.materialService = materialService;
    ...
    JobComponent.prototype.getJob = function () {
        ...
        this.jobService.getJobById(this.id).subscribe(function (job) {
            ...
            _this.customerService.getAllContacts(job[0].customerID).subscribe(function (contacts) {
                _this.contacts = contacts;
            });
        });
    };
    ...
    JobComponent.prototype.getMaterials = function () {
        ...
        this.jobService.getJobMaterialsById(this.id).subscribe(function (jobMaterials) {
            ...
            _this.totalUnitsTable = 0;
            for (var k = 0; k < _this.jobMaterials.length; k++) {
                _this.totalMaterialPriceTable += (_this.jobMaterials[k].pricePerUnit * _this.jobMaterials[k].numberOfUnits);
                _this.totalUnitsTable += _this.jobMaterials[k].numberOfUnits;
            }
            _this.materialService.getAllMaterials().subscribe(function (materials) {
                _this.materials = materials.materials;
    ...
    JobComponent.prototype.clearBillingForm = function () {
        this.line4 = 0;
        this.line6 = 0;
        this.line7 = 0;
        this.line10 = 0;
    };
    JobComponent.prototype.onChangeContact = function (contactIndex) {
        this.contactName = this.contacts[contactIndex].contactName;
    };
    JobComponent.prototype.makeBillingPDF = function () {
        var documentDefinition = {
            pageOrientation: 'landscape',
            //function for page number
            function: function (currentPage, pageCount) { return currentPage.toString() + ' of ' + pageCount; },
            content: [
...
var ReportsComponent = (function () {
    ...
    ReportsComponent.prototype.setupDataTable = function () {
        this.dtOptions = {
            pagingType: 'full_numbers',
            order: [0, 'desc']
        };
