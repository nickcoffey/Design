...
var BidComponent = (function () {
    function BidComponent(router, route, bidService, materialService, jobService, inquiryService, laborService, authService, alert) {
        this.router = router;
        this.route = route;
