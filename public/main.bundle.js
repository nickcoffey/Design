...
var InquiriesComponent = (function () {
    ...
    InquiriesComponent.prototype.ngOnInit = function () {
        ...
        this.inquiryService.getAllInquiries().subscribe(function (inquiries) {
            ...
            _this.pendingInquiriesResource = new __WEBPACK_IMPORTED_MODULE_2_angular_4_data_table__["DataTableResource"](_this.pendingInquiries);
            console.log('Pending ' + _this.pendingLength);
