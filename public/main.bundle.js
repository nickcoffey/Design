...
var BidComponent = (function () {
    function BidComponent(router, route, bidService, materialService, jobService, inquiryService, laborService, alert) {
        this.router = router;
        this.route = route;
...
var InquiryComponent = (function () {
    function InquiryComponent(router, route, inquiryService, materialService, laborService, bidService, alert) {
        this.router = router;
        this.route = route;
        this.inquiryService = inquiryService;
        this.materialService = materialService;
...
var JobComponent = (function () {
    ...
    JobComponent.prototype.setupFileUploader = function () {
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            ...
            _this.ngOnInit();
            _this.alert.displayAlert('File uploaded', 'success');
